                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="price_a" class="col-form-label">Initial Price<font color="#f00">*</font></label>
                                        </div>
                                        <div class="col-md-8 col-xs-8">
                                            <input type="number" name="price_a" id="price_a" class="form-control" style="margin-bottom: 5px;" maxlength="100" autofocus>
