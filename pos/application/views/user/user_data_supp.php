                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" target="_self" name="formku" id="formku" class="eventInsForm">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 col-xs-4">
                                            <label for="level" class="col-form-label">Supplier <font color="#f00">*</font></label>
                                        </div>
                                        <div class="col-md-8 col-xs-8">
                                            <select id="supplier_id" name="supplier_id" class="form-control" style="margin-bottom: 5px;">
                                                <option disabled selected value="">--Pilih--</option>
                                ...
                                foreach ($user as $u) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;width:200px;">
                                            ...
                                            <form action="<?= site_url('user/delete_supp') ?>" method="POST" class="d-inline">
    ...
    function simpandata() {
        if ($.trim($("#username").val()) == "") {
            ...
            if (dsState == "Input") {
                $.ajax({
                    type: "POST",
                    url: "<?= site_url('user/cek_username_sup') ?>",
                    data: {
                        data: $("#username").val()
                    },
                    success: function(result) {
                        if (result == "ADA") {
                            ...
                            $('#message').html("");
                            $('.nama-ada').hide();
                            $('#formku').attr("action", "<?= site_url('user/save_sup') ?>");
                            $('#formku').submit();
                        }
                    }
                });
            } else {
                $('#formku').attr("action", "<?= site_url('user/update_supp') ?>");
                $('#formku').submit();
            }
        };
    };
