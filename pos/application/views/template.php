        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                    ...
                    <div class="info">
                        ...
                        <?php
                            if($this->session->level != '4'){
                                ...
                                echo ucfirst($this->fungsi->supp_login()->username);
                            }
                        ?>
                    </a>
                    </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview <?= $this->uri->segment(2) == 'in' || $this->uri->segment(2) == 'out' || $this->uri->segment(2) == 'stokhabis' || $this->uri->segment(2) == 'req_stok' ? 'menu-open' : '' ?>">
                            <a href="#" class="nav-link <?= $this->uri->segment(2) == 'in' || $this->uri->segment(2) == 'out' || $this->uri->segment(2) == 'stokhabis' || $this->uri->segment(2) == 'req_stok' ? 'active' : '' ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= site_url('stock/stokhabis'); ?>" class="nav-link <?= $this->uri->segment(2) == 'stokhabis' ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Out Off Stock</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= site_url('stock/req_stok'); ?>" class="nav-link <?= $this->uri->segment(2) == 'req_stok' ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Request Stock</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item has-treeview <?= $this->uri->segment(1) == 'category' || $this->uri->segment(1) == 'unit' || $this->uri->segment(1) == 'item' ? 'menu-open' : '' ?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= site_url('mino') ?>" class="nav-link <?= $this->uri->segment(3) == 'mino' ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Minimal Order</p>
                                    </a>
                                </li>
                    ...
                    <?php if ($this->fungsi->user_login()->level == 1) { ?>
                        ...
                        <li class="nav-item">
                            <a href="<?= site_url('user/user_supp') ?>" class="nav-link">
                    ...
                    <?php }elseif($this->session->level == '4'){ ?>
                        <li class="nav-item">
                            <a href="<?= site_url('supplier/stok_supp') ?>" class="nav-link <?= $this->uri->segment(2) == 'stok_supp' ? 'active' : '' ?>">
                                <i class="fas fa-truck nav-icon"></i>
                                <p>Request Stock</p>
                            </a>
                        </li>
